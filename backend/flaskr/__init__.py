...
def create_app(test_config=None):
 ...
 # This formats categories into a dictionary {id, type} and has formatted_categories defined globally for other functions to use
      ...
      try:
          ...
          for question in all_questions:
            if question.id not in previous_questions:
              quiz_question_options.append(question.format())

          result = random.choice(quiz_question_options)
